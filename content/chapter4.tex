...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{rectangular_file_and_bench_vice.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{pure_afff_concentrate_from_supplier.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.85\textwidth]{ftir_instrument.jpg}
